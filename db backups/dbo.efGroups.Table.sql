USE [Complex]
GO
/****** Object:  Table [dbo].[efGroups]    Script Date: 2/11/2025 10:30:58 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[efGroups](
	[ef_group_id] [int] IDENTITY(1,1) NOT NULL,
	[ef_group_type_id] [int] NOT NULL,
 ...
 CONSTRAINT [PK_efGroups] PRIMARY KEY CLUSTERED 
(
	[ef_group_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
SET IDENTITY_INSERT [dbo].[efGroups] ON 

INSERT [dbo].[efGroups] ([ef_group_id], [ef_group_type_id], [group_name], [display_name], [description], [email_notifications], [sms_notifications], [enabled], [created_at], [updated_at], [deleted_at]) VALUES (1, 1, N'Administrators', N'Administrators', NULL, NULL, NULL, NULL, CAST(N'2023-07-07T13:42:40.5033333' AS DateTime2), NULL, NULL)
INSERT [dbo].[efGroups] ([ef_group_id], [ef_group_type_id], [group_name], [display_name], [description], [email_notifications], [sms_notifications], [enabled], [created_at], [updated_at], [deleted_at]) VALUES (2, 1, N'ApplicationSupports', N'Application Supports', NULL, NULL, NULL, NULL, CAST(N'2023-07-07T13:42:40.5033333' AS DateTime2), NULL, NULL)
INSERT [dbo].[efGroups] ([ef_group_id], [ef_group_type_id], [group_name], [display_name], [description], [email_notifications], [sms_notifications], [enabled], [created_at], [updated_at], [deleted_at]) VALUES (3, 1, N'Executives', N'Executives', N'Commissioner, Deputy Commissioner', NULL, NULL, NULL, CAST(N'2023-07-07T13:42:40.5033333' AS DateTime2), NULL, NULL)
...
INSERT [dbo].[efGroups] ([ef_group_id], [ef_group_type_id], [group_name], [display_name], [description], [email_notifications], [sms_notifications], [enabled], [created_at], [updated_at], [deleted_at]) VALUES (7, 1, N'Dispatchers', N'Dispatchers', N'TBD', NULL, NULL, NULL, CAST(N'2023-07-07T13:42:40.5033333' AS DateTime2), NULL, NULL)
...
SET IDENTITY_INSERT [dbo].[efGroups] OFF
GO
ALTER TABLE [dbo].[efGroups]  WITH CHECK ADD  CONSTRAINT [FK_efGroups_GroupTypes] FOREIGN KEY([ef_group_type_id])
REFERENCES [dbo].[efGroupTypes] ([ef_group_type_id])
GO
ALTER TABLE [dbo].[efGroups] CHECK CONSTRAINT [FK_efGroups_GroupTypes]
GO
