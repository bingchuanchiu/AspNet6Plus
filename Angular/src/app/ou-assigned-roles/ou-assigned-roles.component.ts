...
@Component({
  selector: 'app-ou-assigned-roles',
  templateUrl: './ou-assigned-roles.component.html',
  styleUrls: ['./ou-assigned-roles.component.scss']
})
export class OUAssignedRolesComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='OuAssignedRolesAPI';
  primaryIdName : string = "OuAssignedRoleId";
