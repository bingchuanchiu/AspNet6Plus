...
@Component({
  selector: 'app-ou-assigned-roles-edit',
  templateUrl: './ou-assigned-roles-edit.component.html',
  styleUrls: ['./ou-assigned-roles-edit.component.scss']
})

export class OuassignedRolesEditComponent implements OnInit, OnChanges {
