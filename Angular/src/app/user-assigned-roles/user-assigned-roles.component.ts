...
@Component({
  selector: 'app-user-assigned-roles',
  templateUrl: './user-assigned-roles.component.html',
  styleUrls: ['./user-assigned-roles.component.scss']
})
export class UserAssignedRolesComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='UserAssignedRolesAPI';
  primaryIdName : string = "UserAssignedRoleId";
