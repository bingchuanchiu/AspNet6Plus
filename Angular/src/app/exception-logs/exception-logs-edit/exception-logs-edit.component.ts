...
@Component({
  selector: 'app-exception-logs-edit',
  templateUrl: './exception-logs-edit.component.html',
  styleUrls: ['./exception-logs-edit.component.scss']
})
export class ExceptionLogsEditComponent implements OnInit, OnChanges {
  ...
  primaryIdName : string = "ExceptionLogId";
  ...
  */
  ...
  dynFormBuilder: any = [
    {id: "ExceptionLogId", name:"Exception Log Id", elementType:"infoTextfield", required: false, value:"", class:""},
    {id: "Message", name:"Message", elementType:"infoTextarea", required: false, value:"", class:"" },
    {id: "InnerException", name:"Inner Exception", elementType:"infoTextarea", required: true,value:"", class:"" },
    {id: "StackTrace", name:"Stack Trace", elementType:"infoTextarea", required: true,value:"", class:"" },
  ...
  newRecord() {
    ...
    this.primaryForm = new FormGroup({
      ExceptionLogId: new FormControl(),
      Message: new FormControl(null, {nonNullable: true}),
      InnerException : new FormControl(null, {nonNullable: true}),
      StackTrace: new FormControl(null, {nonNullable: true}),
    ...
    if (this.primaryIdInput > 0 ) {
      ...
      .subscribe(data => {
        ...
        this.primaryForm.patchValue({
          ...
          ExceptionLogId: rs.exceptionLogId,
          Message: rs.message,
          InnerException : rs.innerException,
          StackTrace: rs.stackTrace,
