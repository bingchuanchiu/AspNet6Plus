...
export class ExceptionLogsComponent implements OnInit, OnChanges {
...
//  SELECT ARE CASE SENSITIVE! 
 ...
 //odataParams = `null`;// THIS IS WORKING
  ...
  isDateTime(input: any): boolean{
    ...
    return mm > 0 && dd > 0 && yyyy > 1969 ? true : false;
  }
  ...
  isTimeOnly(input: any): boolean{
    ...
    return mm > 0 && dd > 0 && yyyy > 1969 ? false : true;
  }
