...
@Component({
  selector: 'app-plant-areas',
  templateUrl: './plant-areas.component.html',
  styleUrls: ['./plant-areas.component.scss']
})
export class PlantAreasComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='PlantAreasAPI';
  primaryIdName : string = "PlantAreaId";
