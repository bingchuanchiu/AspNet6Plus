...
@Component({
  selector: 'app-plant-areas-edit',
  templateUrl: './plant-areas-edit.component.html',
  styleUrls: ['./plant-areas-edit.component.scss']
})

export class PlantAreasEditComponent implements OnInit, OnChanges {
