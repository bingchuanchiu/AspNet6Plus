...
@Component({
  ...
  styleUrls: ['./user-logs-edit.component.scss']
})

export class UserLogsEditComponent implements OnInit, OnChanges {
  ...
  entity: any ={};
  entityName ='UserLogsAPI';

  primaryForm: any  = new FormGroup({
    UserLogId: new FormControl(),
    Controller: new FormControl(),
    Action : new FormControl(),
    UserAgent: new FormControl(),
    UrlCurrent: new FormControl(),
    UrlReferral: new FormControl(),
  ...
  primaryIdName : string = "UserLogId";
  ...
  */
    ...
    dynFormBuilder: any = [
      {id: "UserLogId", name:"user log id", elementType:"infoTextfield", required: false, value:"", class:""},
      {id: "Controller", name:"Controller", elementType:"infoTextfield", required: false, value:"", class:"" },
      {id: "Action", name:"Action", elementType:"infoTextfield", required: true,value:"", class:"" },
      {id: "UserAgent", name:"User Agent", elementType:"infoTextarea", required: true,value:"", class:"" },
      {id: "UrlCurrent", name:"Url Current", elementType:"infoTextarea", required: false ,value:"", class:"" },
      {id: "UrlReferral", name:"Url Referral", elementType:"infoTextarea", required: false,value:"", class:""},
      {id: "ClientIP", name:"Client IP", elementType:"infoTextfield", required: false,value:"", class:"" },
      {id: "Message", name:"message", elementType:"infoTextarea", required: false,value:"", class:"" },
  ...
  newRecord() {
    ...
    this.primaryForm = new FormGroup({
      UserLogId: new FormControl(),
      Controller: new FormControl(null, {nonNullable: true}),
      Action : new FormControl(null, {nonNullable: true}),
      UserAgent: new FormControl(null, {nonNullable: true}),
      UrlCurrent: new FormControl(null, {nonNullable: true}),
      UrlReferral: new FormControl(null, {nonNullable: true}),
      ClientIP : new FormControl(null, {nonNullable: true}),
    ...
    if (this.primaryIdInput > 0 ) {
      ...
      .subscribe(data => {
        ...
        this.primaryForm.patchValue({
          ...
          UserLogId: rs.userLogId,
        Controller: rs.controller,
        Action : rs.action,
        UserAgent: rs.userAgent,
        UrlCurrent: rs.urlCurrent,
        UrlReferral: rs.urlReferral,
