...
@Component({
  selector: 'app-user-assigned-groups',
  templateUrl: './user-assigned-groups.component.html',
  styleUrls: ['./user-assigned-groups.component.scss']
})
export class UserAssignedGroupsComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='UserAssignedGroupsAPI';
  primaryIdName : string = "UserAssignedGroupId";
