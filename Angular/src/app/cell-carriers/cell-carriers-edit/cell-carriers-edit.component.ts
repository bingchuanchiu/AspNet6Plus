...
@Component({
  selector: 'app-cell-carriers-edit',
  templateUrl: './cell-carriers-edit.component.html',
  styleUrls: ['./cell-carriers-edit.component.scss']
})

export class CellCarriersEditComponent implements OnInit, OnChanges {
