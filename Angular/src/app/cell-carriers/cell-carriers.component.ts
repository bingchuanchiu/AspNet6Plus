...
@Component({
  selector: 'app-cell-carriers',
  templateUrl: './cell-carriers.component.html',
  styleUrls: ['./cell-carriers.component.scss']
})
export class CellCarriersComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='CellCarriersAPI';
  primaryIdName : string = "CellCarrierId";
