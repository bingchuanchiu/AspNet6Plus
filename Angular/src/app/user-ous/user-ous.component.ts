...
@Component({
  selector: 'app-user-ous',
  templateUrl: './user-ous.component.html',
  styleUrls: ['./user-ous.component.scss']
})
export class UserOusComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='UserOusAPI';
  primaryIdName : string = "UserOuId";
