...
@Component({
  selector: 'app-user-ous-edit',
  templateUrl: './user-ous-edit.component.html',
  styleUrls: ['./user-ous-edit.component.scss']
})

export class UserOusEditComponent implements OnInit, OnChanges {
