...
@Component({
  selector: 'app-group-assigned-ous',
  templateUrl: './group-assigned-ous.component.html',
  styleUrls: ['./group-assigned-ous.component.scss']
})
export class GroupAssignedOusComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='GroupAssignedOusAPI';
  primaryIdName : string = "GroupAssignedOuId";
 ...
 // @Input() pcaseIdInput: any = null; //NEED TO RENAME OR REMOVE
