...
@Component({
  selector: 'app-group-assigned-roles',
  templateUrl: './group-assigned-roles.component.html',
  styleUrls: ['./group-assigned-roles.component.scss']
})
export class GroupAssignedRolesComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='GroupAssignedRolesAPI';
  primaryIdName : string = "GroupAssignedRoleId";
