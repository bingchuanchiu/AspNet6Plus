...
@Component({
  selector: 'app-passwords-edit',
  templateUrl: './passwords-edit.component.html',
  styleUrls: ['./passwords-edit.component.scss']
})

export class PasswordsEditComponent implements OnInit, OnChanges {
