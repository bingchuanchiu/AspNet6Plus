...
@Component({
  selector: 'app-role-assigned-permissions',
  templateUrl: './role-assigned-permissions.component.html',
  styleUrls: ['./role-assigned-permissions.component.scss']
})
export class RoleAssignedPermissionsComponent implements OnInit, OnChanges {
