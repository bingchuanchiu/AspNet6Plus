...
@Component({
  selector: 'app-user-assigned-cell-carriers',
  templateUrl: './user-assigned-cell-carriers.component.html',
  styleUrls: ['./user-assigned-cell-carriers.component.scss']
})
export class UserAssignedCellCarriersComponent implements OnInit, OnChanges {
 ...
 @Input() oDataInput: any = null;
  ...
  entities:any;
  entityName ='UserAssignedCellCarriersAPI';
  primaryIdName : string = "UserAssignedCellCarrierId";
